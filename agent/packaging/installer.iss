...
OutputDir=C:\Users\kaviraja\Desktop\DRM\agent\dist
OutputBaseFilename=arqx-atlas-agent-setup
PrivilegesRequired=lowest
[Files]
Source: "C:\Users\kaviraja\Desktop\DRM\agent\dist\arqx-atlas-agent.exe"; DestDir: "{app}"; Flags: ignoreversion
[Icons]
...
Root: HKCU; Subkey: "Software\Classes\arqx\shell\open\command"; ValueType: string; ValueData: """{app}\arqx-atlas-agent.exe"""
